...
class PriceHistoryCompetitors(models.Model):
    ...
    def create(self, values):
        ...
        if not record.product_competitors.product.id: return record

        product = model_products.search([("id", "=", record.product_competitors.product.id)])
        ...
        for price_history_id in product.competitors_with_price_ids:
            ...
            if record.product_competitors.id == price_history_record.product_competitors.id:
